...
M0 与 M1 已完成，M2 第一阶段 Electron 桌面壳正在验收。当前已接通本地 Express tool server、Ollama、ComfyUI Workflow API、自定义图片形状与文件系统持久化，真实 Flux.2 klein 闭环已在 Apple M4 16GB 上验证。代码钩子和 API 调研见 [`docs/notes.md`](docs/notes.md)，进度和手测记录见 [`PROGRESS.md`](PROGRESS.md)。
